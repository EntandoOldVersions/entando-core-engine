...
--
-- Create schema EntandotestPort
--

CREATE DATABASE IF NOT EXISTS EntandotestPort;
USE EntandotestPort;
CREATE TABLE  `EntandotestPort`.`categories` (
  `catcode` varchar(30) NOT NULL,
  `parentcode` varchar(30) NOT NULL,
  `titles` longtext NOT NULL,
  PRIMARY KEY (`catcode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO `EntandotestPort`.`categories` VALUES  ('Attach','resource_root','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<properties>\n<property key=\"it\">Attach</property>\n</properties>\n\n'),
...
CREATE TABLE  `EntandotestPort`.`contentmodels` (
...
CREATE TABLE  `EntandotestPort`.`contentrelations` (
...
INSERT INTO `EntandotestPort`.`contentrelations` VALUES  ('RAH1',NULL,NULL,NULL,NULL,'free'),
...
CREATE TABLE  `EntandotestPort`.`contents` (
  `contentid` varchar(16) NOT NULL,
  `contenttype` varchar(30) NOT NULL,
...
CREATE TABLE  `EntandotestPort`.`contentsearch` (
  `contentid` varchar(16) NOT NULL,
...
INSERT INTO `EntandotestPort`.`contentsearch` VALUES  ('ART120','Data',NULL,'2009-03-28',NULL,NULL),
...
CREATE TABLE  `EntandotestPort`.`pages` (
...
CREATE TABLE  `EntandotestPort`.`resourcerelations` (
...
INSERT INTO `EntandotestPort`.`resourcerelations` VALUES  ('44','resource_root'),
 ('44','Image'),
 ('44','resCat1');
CREATE TABLE  `EntandotestPort`.`resources` (
  `resid` varchar(16) NOT NULL,
...
CREATE TABLE  `EntandotestPort`.`showletcatalog` (
  `code` varchar(40) NOT NULL,
  `titles` longtext NOT NULL,
  `parameters` longtext,
  `plugincode` varchar(30) DEFAULT NULL,
...
INSERT INTO `EntandotestPort`.`showletconfig` VALUES  ('coach_page',2,'content_viewer','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<properties>\n<property key=\"contentId\">ART187</property>\n</properties>\n\n','ART187'),
...
CREATE TABLE  `EntandotestPort`.`sysconfig` (
...
CREATE TABLE  `EntandotestPort`.`uniquekeys` (
  `id` int(11) NOT NULL DEFAULT '0',
  `keyvalue` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO `EntandotestPort`.`uniquekeys` VALUES  (1,200);
CREATE TABLE  `EntandotestPort`.`workcontentrelations` (
  `contentid` varchar(16) NOT NULL,
  `refcategory` varchar(30) DEFAULT NULL,
...
INSERT INTO `EntandotestPort`.`workcontentrelations` VALUES  ('ART179','general'),
 ('ART179','general_cat1'),
 ('ART179','general_cat2'),
 ('ART180','cat1'),
 ('ART180','general'),
 ...
 ('EVN193','general'),
 ('EVN193','general_cat2');
CREATE TABLE  `EntandotestPort`.`workcontentsearch` (
...
INSERT INTO `EntandotestPort`.`workcontentsearch` VALUES  ('ART120','Data',NULL,'2009-03-28',NULL,NULL),
 ('ART120','Numero',NULL,NULL,7,NULL),
