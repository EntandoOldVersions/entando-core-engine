...
public class GuiFragmentListResponseResult extends AbstractApiResponseResult {
    ...
    public ListResponse<JAXBGuiFragment> getResult() {
        if (this.getMainResult() instanceof Collection) {
            List<JAXBGuiFragment> guiSections = new ArrayList<JAXBGuiFragment>();
            guiSections.addAll((Collection<JAXBGuiFragment>) this.getMainResult());
            ListResponse<JAXBGuiFragment> entity = new ListResponse<JAXBGuiFragment>(guiSections) {};
            return entity;
        }
        return null;
    }
